...
<spring:url value="/student/${studentFormUpdate.id}/update" var="userActionUrl" />

<form:form id="studentFormUpdate" method="post" modelAttribute="studentFormUpdate" class="form-horizontal" role="form" action="${userActionUrl}" style="margin-top:80px;">
